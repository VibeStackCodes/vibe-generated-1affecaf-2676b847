...
const tasks = [
  {
    "description": "Build category-based expense entry form with category dropdown selector, amount input, date picker, merchant field, and notes textarea",
    "id": "task-002"
  },
  {
    "description": "Build line chart component for category spend over time with date range picker (start date and end date inputs)",
    "id": "task-004"
  },
  {
    "description": "Implement client-side state management using React hooks (useState, useContext) to manage expenses, categories, filters, and date ranges across components",
    "id": "task-012"
  }
];
